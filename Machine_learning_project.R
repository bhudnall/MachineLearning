...
#     - Can use any variable in the data set to ppredict
#     - Describe how:
#         - built model - USE REGRESSION POTENTIALLY
#         
...
#           In sample error is the error we get from the training set. 
#         
...
#     - Create an algorithm using the train function, test different algorithms using train 
